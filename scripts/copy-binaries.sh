...
if [[ $OSTYPE == 'darwin'* ]]; then
  cp electron/node_modules/@lightningrodlabs/electron-holochain/binaries/lair-keystore electron/binaries/lair-keystore
  ...
  cp electron/node_modules/@lightningrodlabs/electron-holochain/binaries/lair-keystore.exe electron/binaries/lair-keystore.exe
