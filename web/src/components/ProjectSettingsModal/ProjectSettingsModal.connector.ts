...
import ProjectSettingsModal, { ProjectSettingsModalDispatchProps, ProjectSettingsModalOwnProps } from './ProjectSettingsModal.component'
...
function mapDispatchToProps(dispatch: any, ownProps: ProjectSettingsModalOwnProps): ProjectSettingsModalDispatchProps {
