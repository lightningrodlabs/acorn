...
function Internal({ navigation, setNavigationSelected, save }) {
  const trackpadOption = <PreferenceSelectOption
    ...
    title="Trackpad"
  />
  const mouseOption = <PreferenceSelectOption
  ...
  return (
    <div className='preferences-content-wrapper'>
      ...
      <PreferenceSelect iconName="panning.svg" title="Navigation Mode" subtitle="Select your preferred navigation mode on canvas based on your primary
          pointer device" options={[trackpadOption, mouseOption]} descriptions={<Descriptions navigation={navigation} />} />
