...
const HIGH_PRIORITY_GLOW_COLOR = '#334CF8'
...
const CONNECTION_ACHIEVED_SELECTED_OUTCOME_COLOR = '#82B282'
const CONNECTION_NOT_ACHIEVED_SELECTED_OUTCOME_COLOR = '#CDC2A2'
