...
const USER_DATA_PATH = app.isPackaged ? app.getPath('userData') : path.join(__dirname, `../../user${userNumber}-data/`)
...
export { USER_DATA_PATH, USER_DATA_MIGRATION_FILE_PATH, PREV_VER_USER_DATA_MIGRATION_FILE_PATH }